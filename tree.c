...
/* patignore, patinclude moved to src/main.zig (Phase 4) */
/* getinfo, read_dir, push_files, unix_getfulltree moved to src/main.zig (Phase 7) */
...
/* stat2info, getinfo, read_dir, push_files, unix_getfulltree moved to src/main.zig (Phase 7) */
